...
| [`docs/`](./docs) | Engineering runbooks — see [`agentic-workflow.md`](./docs/agentic-workflow.md) (agent/CI loop) and [`play-store-release.md`](./docs/play-store-release.md) (build → sign → Firebase App Distribution / Play Store). |
