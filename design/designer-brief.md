...
- **On tablet/desktop-width screens** (≥ 840dp), the entire "Log a drink" section (heading, dropdown, grid) relocates to sit **beside** the progress card and stat cards instead of below them, forming an evenly-split (50/50) two-column page; see [user-experience.md → Responsive layout](./user-experience.md#responsive-layout) for the full breakpoint/column table.
