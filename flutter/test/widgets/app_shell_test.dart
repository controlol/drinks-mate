...
const _appShellBeerPreset = DrinkPreset(
  id: 'app-shell-test-beer-preset',
  name: 'Test Beer',
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // asserts against is unchanged, while giving the session the drink it
      // needs to actually auto-end instead of being silently discarded.
      await realPartyRepo.logAlcoholicDrink(
        preset: _appShellBeerPreset,
